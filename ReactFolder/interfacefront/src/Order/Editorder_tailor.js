          ...
          <div className="col-lg-12 col-sm">
            <div className="form">
              <form class="form-inline" onSubmit={updateorder}>
                ...
                >
                  <option className="option" value="Add Status">
                    Add Status
                  </option>
                  <option className="option" value="Accepted">
                    Accepted
                  </option>
                ...
                >
                  ...
                  <option className="option" value="50% done">
                    50 % done
                  </option>
                  <option className="option" value="70% done">
                    70 % done
                  </option>
                  <option className="option" value="90% done">
                    90 % done
                  </option>
                  <option className="option" value="Complete">
                    Complete
                  </option>
                  <option
                    className="option"
                    value="Customer Can Get Your Dress Tomorrow"
                  >
                    Delivered
                  </option>
                </select>
