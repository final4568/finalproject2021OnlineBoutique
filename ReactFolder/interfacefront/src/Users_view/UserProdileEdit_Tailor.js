      ...
      <div
        ...
        <div className="form-container">            
            ...
            <label className="formlable" for="name"> <strong>Name :</strong> </label>
                ...
                <label className="formlable" for="phone"> <strong>Phone :</strong> </label>
                <div className="field">
                ...
                <div className="">
                <textarea type="" placeholder="Address" name ="address" id="address" required
                    value = {address}
...
export default UserProdileEdit_Tailor;
