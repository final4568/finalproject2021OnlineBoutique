...
const UpdateProduct_tailor = ({ history, match }) => {
  ...
  const onsubmitInput = (e) => {
    ...
    axios
      .put(`/api/product/update/${match.params.id}`, fromData, config)
      .then((response) => {
                ...
                <div className="form-inner">
                  <form className="login" onSubmit={onsubmitInput}>
                    <div className="xyz" style={{ marginTop: "40px" }}>
                      <label className="formlable" for="Product Name">
                      ...
                      <label className="formlable" for="Product Category">
                      ...
                      <label className="formlable" for="Product Category">
                        <strong>Aurthor :</strong>{" "}
                      </label>
                      <div className="field">
                        <select
                          value={product_uploadby}
                          onChange={(e) => {
                            setULby(e.target.value);
                          }}
                          style={{ width: "100%", height: "40px" }}
                        >
                      ...
                      <label className="formlable" for="Product Description">
